...
public class Utils {
    ...
    public static User user2 = new User(2L, 50000.0, UUID.randomUUID(), false, "Apple", "John");
    public static Sales sales1 = new Sales(1L, product1, user, new Date(), 5, new BigDecimal("100.00"), false);
    public static Sales sales2 = new Sales(2L, product2, user, new Date(), 3, new BigDecimal("90.00"), true);
